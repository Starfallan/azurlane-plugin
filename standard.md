...
以较为常见的 [yenai-plugin](https://github.com/yeyang52/yenai-plugin) 为例，插件基本目录结构如下：
...
### apps <Badge text="重点" type="important" vertical="middle" />
...
### guoba <Badge text="拓展" type="info" vertical="middle" />

**锅巴插件专用目录**  

- 用于支持 [guoba-plugin](https://github.com/guoba-yunzai/guoba-plugin)，提供 Web 配置和信息展示。
...
- `modules`：功能模块或业务单元，实现具体业务逻辑，可复用 `model`、`lib`、`components` 中的能力。
...
### node_modules <Badge text="自动生成" type="note" vertical="middle" />
...
| `package.json`        | 项目信息与依赖，[👉 npm 官方文档说明](https://nodejs.cn/npm/cli/v8/configuring-npm/package-json/)                         |
| `README.md`           | 项目说明文档                           |

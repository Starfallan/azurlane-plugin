...
export const WIKI_COMMAND_PREFIX_RULE = /^(?:;|；|碧蓝航线|碧蓝).*$/i

export const WIKI_COMMAND_RULE = new RegExp(`^(?:(?:;|；)\\s*(?:碧蓝|碧蓝航线|blhx)?|(?:碧蓝航线|碧蓝))\\s*(.+?)(技能|天赋|资料|图鉴|属性|配装|配装推荐|推荐配装|装备)${TRAILING_PUNCTUATION}$`, 'i')

const WIKI_COMMAND_REG = /^(?:(?:;|；)\s*(?:碧蓝|碧蓝航线|blhx)?|(?:碧蓝航线|碧蓝))\s*(.+?)(技能|天赋|资料|图鉴|属性|配装|配装推荐|推荐配装|装备)[.。~～…]*$/i
